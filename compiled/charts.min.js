...
e}return d};return f}();var C,r,M=function(f,a){return function(){return f.apply(a,arguments)}};C=function(){function f(){this.scale=M(this.scale,this)}f.prototype.domain=function(a){this.domain_min=Math.min.apply(Math.min,a);this.domain_max=Math.max.apply(Math.max,a);return this};f.prototype.range=function(a){this.range_min=Math.min.apply(Math.min,a);this.range_max=Math.max.apply(Math.max,a);return this.scale};f.prototype.scale=function(a){var b;b=this.domain_max-this.domain_min;return(this.domain_max*
...
d,e;if(b==null)b=0;c=a.getBBox();d=c.x;e=c.x+c.width;c=c.y+b;return[new k(d,c),new k(e,c)]};f.prototype.one_px_highlight=function(a){a=this.get_points_along_top_of_bbox(a,2);this.straight_line(a[0],a[1]).attr({"stroke-width":1,stroke:"rgba(255,255,255,0.3)"});return this.straight_line};f.prototype.one_px_shadow=function(a){a=this.get_points_along_top_of_bbox(a);this.straight_line(a[0],a[1]).attr({"stroke-width":0.5,stroke:"rgba(0,0,0,0.5)"});return this.straight_line};return f}();n.Effects=D;var z;
z=function(){function f(a,b,c,d){var e,g,h=this;this.r=a;if(d==null)d=true;if(typeof c==="number")c=Math.round(c*100)/100;e=b.getBBox();g=e.x;a=e.y;e=g+e.width/2;this.popup=this.r.set();this.popup.push(this.r.rect(e-25,a-35,50,25,5));this.popup.push(this.r.triangle(e,a-10+4,4).rotate(180));this.popup.attr({fill:"rgba(0,0,0,.4)","fill-opacity":0,stroke:"transparent","stroke-width":0});this.text=this.r.text(e,a-22.5,c);this.text.attr({fill:"#fff","font-size":14,"text-anchor":"middle",width:50,height:25,
...
"stroke-width":0});return a.toBack()};f.prototype.draw_dots_and_tooltips=function(){var a,b,c,d,e,g,h,i,j;h=this.scaled_points;g=this.raw_points;i=[];a=[];b=d=c=0;for(j=h.length;b<j;b++){e=h[b];a.push(new u(this.r,e,this.options));i.push(new z(this.r,a[b].element,g[b].y));if(g[b].y>=g[c].y)c=b;if(g[b].y<g[d].y)d=b}if(this.options.label_max){i[c].show();a[c].activate()}if(this.options.label_min){i[d].show();return a[d].activate()}};return f}();o=function(){function f(a,b){var c,d;c=document.getElementById(a);
d=this.get_dimensions(c);this.width=d[0];this.height=d[1];this.r=Raphael(c,this.width,this.height);this.options=b}f.prototype.get_dimensions=function(a){var b;b=parseInt(a.style.width);a=parseInt(a.style.height);return[b,a]};return f}();var v;p=Object.prototype.hasOwnProperty;q=function(f,a){function b(){this.constructor=f}for(var c in a)if(p.call(a,c))f[c]=a[c];b.prototype=a.prototype;f.prototype=new b;f.__super__=a.prototype;return f};v=function(f){function a(b,c){if(c==null)c={};a.__super__.constructor.call(this,
b,new w(c));this.padding=26;this.all_points=[];this.line_indices=[];this.line_options=[]}q(a,f);a.prototype.add_line=function(b){var c,d,e,g;d=b.data;if(!(d.length<1)){e=function(){var h,i,j;j=[];h=0;for(i=d.length;h<i;h++){c=d[h];j.push(new k(c[0],c[1]))}return j}();g=this.all_points.length;this.line_indices.push([g,g+e.length-1]);this.all_points.push.apply(this.all_points,e);this.line_options.push(w.merge(this.options,b.options))}};a.prototype.draw_grid=function(b,c){var d,e,g,h,i,j;if(b==null)b=
...
true&&this.draw_grid(this.x_label_coordinates,this.y_label_coordinates)}}}};return a}(o);n.LineChart=v;var K,L;p=Object.prototype.hasOwnProperty;q=function(f,a){function b(){this.constructor=f}for(var c in a)if(p.call(a,c))f[c]=a[c];b.prototype=a.prototype;f.prototype=new b;f.__super__=a.prototype;return f};K=function(f,a,b){return{label:f,raw_value:a,index_value:b}};L=function(f,a,b){return{label:f,index_value:a,opacity:b}};v=function(f){function a(b,c){if(c==null)c={};a.__super__.constructor.call(this,
b,new H(c));this.effects=new D(this.r);this.bars=[];this.guides=[];this.index=100}q(a,f);a.prototype.add=function(b,c,d){return this.bars.push(K(b,c,d))};a.prototype.add_guide_line=function(b,c,d){if(d==null)d=1;return this.guides.push(L(b,c,d))};a.prototype.add_raw_label=function(b){var c,d=this;c=(new x(this.r)).x(function(){return d.width-10}).y(function(e){return e*15+15}).size(this.options.label_size).attr({fill:"#333","text-anchor":"end","font-weight":"bold"});c.draw(b);return c.draw("(raw value)").attr({"font-weight":"normal",
...
return this.render_bar(b,d,e-b,this.options.bar2_color)}else return this.render_bar(this.options.x_padding,d,e-this.options.x_padding)};a.prototype.draw_guide_line=function(b,c,d,e){var g,h;if(e==null)e=1;h=new k(d,this.options.y_padding);g=new k(d,this.height);this.effects.vertical_dashed_line(h,g,this.options.dash_width).attr({fill:"rgba(0,0,0,"+e+")","stroke-width":0});e=(new x(this.r)).x(function(){return d}).y(function(i){return i*15+15}).size(this.options.label_size).attr({fill:"rgba(0,0,0,"+
e+")"});e.draw(b).attr({"font-weight":"bold"});return e.draw(c).attr({"font-size":10})};a.prototype.sort_bars_by_index=function(){var b,c;c=function(){var d,e,g,h;g=this.bars;h=[];d=0;for(e=g.length;d<e;d++){b=g[d];h.push(b)}return h}.call(this);c.sort(function(d,e){return e.index_value-d.index_value});return c};a.prototype.draw=function(){var b,c,d,e,g,h,i,j,l,m,t,A=this;this.set_bar_height();this.set_threshold();h=this.bar_height+this.options.bar_margin;d=this.bar_height/2;l=this.options.y_padding;
e=(new x(this.r)).y(function(y){return y*h+l+d}).x(function(){return 5}).size(12).attr({fill:"#fff","text-anchor":"start"});g=(new x(this.r)).y(function(y){return y*h+l+d}).x(function(){return A.width-10}).size(this.options.label_size).attr({fill:"#333","text-anchor":"end"});i=(new C).domain([0,this.threshold]).range([this.options.x_padding,this.width-this.options.x_padding]);j=function(y){return y*(A.bar_height+A.options.bar_margin)+A.options.y_padding};t=this.sort_bars_by_index();c=0;for(m=t.length;c<
m;c++){b=t[c];this.draw_bg_bar(b.index_value,i,j(c));this.draw_raw_bar(b.raw_value,j(c));this.draw_bar(b.index_value,i,j(c));g.draw(b.raw_value);b=e.draw(b.label);this.effects.black_nub(b)}j=this.guides;m=[];e=0;for(g=j.length;e<g;e++){c=j[e];m.push(this.draw_guide_line(c.label,c.index_value,i(c.index_value),c.opacity))}return m};return a}(o);n.IndexChart=v;var F;p=Object.prototype.hasOwnProperty;q=function(f,a){function b(){this.constructor=f}for(var c in a)if(p.call(a,c))f[c]=a[c];b.prototype=a.prototype;
f.prototype=new b;f.__super__=a.prototype;return f};F=function(f,a,b,c){return{label:f,value:a,average:b,comparison:c}};v=function(f){function a(b,c){if(c==null)c={};a.__super__.constructor.call(this,b,new G(c));this.bars=[]}q(a,f);a.prototype.add=function(){return this.bars.push(F.apply(F,arguments))};a.prototype.draw_background=function(b,c){return this.r.rect(this.options.x_padding,c,b.x,this.options.area_width).attr({fill:this.options.area_color,"stroke-width":0})};a.prototype.draw_line=function(b,
c){return this.r.rect(this.options.x_padding,c.y-this.options.line_width/2,b.x,this.options.line_width).attr({fill:this.options.line_color,"stroke-width":0})};a.prototype.draw_average=function(b,c){return this.r.rect(b.x-this.options.average_width/2,c-this.options.average_height/2,this.options.average_width,this.options.average_height).attr({fill:this.options.average_color,"stroke-width":0})};a.prototype.draw_label=function(){};a.prototype.draw=function(){var b,c,d,e,g,h,i,j;i=this.bars;j=[];c=0;
for(h=i.length;c<h;c++){b=i[c];e=r.scale_points(this.width,this.height,[new k(b.comparison,0),new k(b.value,0),new k(b.average,0),new k(0,0)],this.options.x_padding,this.options.y_padding);g=c*(this.options.area_width+this.options.bar_margin);this.draw_background(e[0],g);d=g+this.options.area_width/2;this.draw_line(e[1],new k(e[0].x,d));this.draw_average(e[2],d);j.push((new s(this.r,0,g+this.options.area_width/2,b.label,"",this.size=14,this.options.font_family)).draw())}return j};return a}(o);n.BulletChart=
v;p=Object.prototype.hasOwnProperty;q=function(f,a){function b(){this.constructor=f}for(var c in a)if(p.call(a,c))f[c]=a[c];b.prototype=a.prototype;f.prototype=new b;f.__super__=a.prototype;return f};o=function(f){function a(b,c){if(c==null)c={};a.__super__.constructor.call(this,b,new B(c));this.effective_height=this.height-this.options.y_padding;this.bar_options=[];this.bars=[];this.values=[]}q(a,f);a.prototype.add=function(b){var c,d;c=b.label;d=b.value;this.bar_options.push(B.merge(this.options,
b.options));this.values.push(d);return this.bars.push({label:c,value:d})};a.prototype.render_bar=function(b,c,d,e){this.r.rect(d.x,d.y,this.options.bar_width,this.effective_height-d.y,this.options.rounding).attr({fill:e.bar_color,"stroke-width":0});(new s(this.r,d.x+this.options.bar_width/2,this.height-(this.options.x_label_size+5),b,"",this.options.x_label_size,this.options.font_family,this.options.x_label_color)).draw();return(new s(this.r,d.x+this.options.bar_width/2,d.y-this.options.y_label_size-
...
e=this.scaled_values[c].y;d=new k(d,e);j.push(this.render_bar(b.label,b.value,d,this.bar_options[c]))}return j};return a}(o);n.BarChart=o});})();
