...
h*c/d;c=f.y-i*c/d;d=new l(e,b);c=new l(a,c);return[d,c]};g.get_prev_and_next_points=function(b,a){var c,d;d=a-1;c=a+1;if(d<0)d=0;if(c>=b.length)c=b.length-1;return[b[d],b[c]]};g.get_tangent=function(b,a){return[a.x-b.x,a.y-b.y]};return g}();r.Bezier=J;var R;R=function(){function g(b,a,c,d,e,f){this.r=b;this.raw_points=a;this.scaled_points=c;this.height=d;this.width=e;this.options=f!=null?f:{}}g.prototype.draw=function(){var b;b=J.create_path(this.scaled_points,this.options.smoothing);this.options.fill_area&&
...
"fill-opacity":this.options.area_opacity,stroke:"none"});return b.toBack()};g.prototype.draw_dots_and_tooltips=function(){var b,a,c,d,e,f,h,i,j,k;h=this.scaled_points;f=this.raw_points;i=[];b=[];a=j=d=c=0;for(k=h.length;j<k;a=++j){e=h[a];b.push(new B(this.r,e,this.options));i.push(new C(this.r,b[a].element,f[a].y));if(f[a].y>=f[c].y)c=a;if(f[a].y<f[d].y)d=a}if(this.options.label_max){i[c].show();b[c].activate()}if(this.options.label_min){i[d].show();return b[d].activate()}};return g}();var w,S;S=
function(g){return g.tagName!==void 0?true:false};w=function(){function g(b,a){var c,d;c=S(b)?b:document.getElementById(b);d=this.get_dimensions(c);this.width=d[0];this.height=d[1];this.r=Raphael(c,this.width,this.height);this.options=a}g.prototype.get_dimensions=function(b){var a;a=parseInt(b.style.width);b=parseInt(b.style.height);return[a,b]};g.prototype.clear=function(){return this.r.clear()};return g}();var T,U,V,K;t={}.hasOwnProperty;s=function(g,b){function a(){this.constructor=g}for(var c in b)if(t.call(b,
c))g[c]=b[c];a.prototype=b.prototype;g.prototype=new a;g.__super__=b.prototype;return g};U=function(g){function b(a){return b.__super__.constructor.call(this,a,b.DEFAULTS)}s(b,g);b.DEFAULTS={main_circle_radius:70,child_radius_multiplier:0.15,hover_scale_multiplier:1.2,inactive_opacity:0.4,outer_radius_multiplier:1.35,outer_radius2_multiplier:1.5,bounce_radius:1.2,fill_color:"#00a6dd"};return b}(v);K=function(g,b,a){return new l(b*Math.cos(a)+g.x,b*Math.sin(a)+g.y)};V=function(g,b,a,c,d){var e;e=function(f,
h,i,j){if(j==null)j=void 0;return f.animate({x:h.x,y:h.y,cx:h.x,cy:h.y},i,"<",j)};return e(g,b,c,function(){return e(g,a,d)})};T=function(g){function b(a,c){if(c==null)c={};b.__super__.constructor.call(this,a,new U(c));this.center_point=new l(this.width/2,this.height/2);this.main_radius=this.options.main_circle_radius;this.child_radius=this.main_radius*this.options.child_radius_multiplier;this.outer_radius=this.main_radius*this.options.outer_radius_multiplier;this.outer_radius2=this.outer_radius*
this.options.outer_radius2_multiplier;this.bounce_radius=this.outer_radius*this.options.bounce_radius;this.children=[]}s(b,g);b.prototype.add_hover=function(a){var c,d,e=this;c=function(){a[0].animate({r:e.options.hover_scale_multiplier*e.child_radius,opacity:1,"stroke-width":2,stroke:"rgba(0,0,0,.4)"},200);a[1].animate({"font-size":22,opacity:1,fill:"#fff"},200);return a._label.animate({opacity:1},200)};d=function(){a[0].animate({r:e.child_radius,opacity:e.options.inactive_opacity,stroke:"none",
"stroke-width":0},200);a[1].animate({opacity:0},200);return a._label.animate({opacity:0},200)};a._activate=c;a._deactivate=d;return a.hover(c,d)};b.prototype.add=function(a){return this.children.push(a)};b.prototype.create_circles_along_radius=function(a,c,d,e){var f,h,i,j,k,m,o,n,p;j=2*Math.PI/24;p=[];h=o=0;for(n=a.length;o<n;h=++o){i=a[h];h=h*j;f=K(this.center_point,d,h);k=f.x;m=f.y;f=this.draw_circle(this.center_point.x,this.center_point.y,c,16);f._realx=k;f._realy=m;f._radians=h;f.attr({opacity:this.options.inactive_opacity}).toFront();
f[1].attr({opacity:0});this.add_label_to_circle(i,f);this.add_hover(f);p.push(e(i,f))}return p};b.prototype.bounce_circles=function(a,c){var d,e,f,h,i,j,k;if(c){k=[];h=i=0;for(j=c.length;i<j;h=++i){f=c[h];e=f._radians;d=K(this.center_point,this.bounce_radius,e);e=d.x;d=d.y;e=new l(e,d);if(a._active){d=c.length-h;h=this.center_point;f.toBack()}else{d=h;h=new l(f._realx,f._realy);f.toFront()}d=100+d*10;k.push(V(f,e,h,d,100))}return k}};b.prototype.add_click_to_circle=function(a,c){var d,e=this;if(c==
null)c=false;d=function(){var f,h,i,j,k;if(a._active){a.hover(a._activate,a._deactivate);h=0;if(a._children){k=a._children;i=0;for(j=k.length;i<j;i++){f=k[i];if(f._active){f._deactivate();f._click_handler()}}}}else{a.unhover(a._activate,a._deactivate);h=45}e.bounce_circles(a,a._children);a.animate({transform:"r"+h},200);return a._active=!a._active};a._click_handler=d;return a.click(d)};b.prototype.add_label_to_circle=function(a,c){var d,e,f;d=this.r.text(c._realx,c._realy,a.label).attr({"font-size":14});
e=this.r.text(c._realx,c._realy+15,F(a.value)).attr({"font-size":12,fill:this.options.fill_color}).toBack();f=this.r.set();f.push(d);f.push(e);if(c._realx>this.center_point.x){d="start";e=30}else{d="end";e=-30}f.attr({"text-anchor":d,x:c._realx+e,opacity:0});return c._label=f};b.prototype.add_grandchildren=function(a,c){if(a.children){c._children=[];return this.create_circles_along_radius(a.children,this.child_radius,this.outer_radius2,function(d,e){c._active=false;return c._children.push(e)})}};
b.prototype.draw_circle=function(a,c,d,e){var f,h;f={fill:this.options.fill_color,stroke:"none"};h=this.r.set();h.push(this.r.circle(a,c,d).attr(f));h.push(this.r.text(a,c,"+").attr({"font-size":e,fill:"#fff"}));return h.attr({cursor:"pointer"}).toFront()};b.prototype.draw=function(){var a,c=this;a=this.draw_circle(this.center_point.x,this.center_point.y,this.main_radius,100);a._active=false;a._children=[];this.add_click_to_circle(a,true);this.create_circles_along_radius(this.children,this.child_radius,
this.outer_radius,function(d,e){c.add_grandchildren(d,e);c.add_click_to_circle(e);return a._children.push(e)});return a.toFront()};return b}(w);r.PathMenu=T;var W,X;t={}.hasOwnProperty;s=function(g,b){function a(){this.constructor=g}for(var c in b)if(t.call(b,c))g[c]=b[c];a.prototype=b.prototype;g.prototype=new a;g.__super__=b.prototype;return g};X=function(g,b,a,c,d){var e,f,h;f=360/c*a;e=(90-f)*Math.PI/180;h=g+d*Math.cos(e);e=b-d*Math.sin(e);return{path:c===a?[["M",g,b-d],["A",d,d,0,1,1,g-0.01,
b-d]]:[["M",g,b-d],["A",d,d,0,+(f>180),1,h,e]]}};W=function(g){function b(a){return b.__super__.constructor.call(this,a,b.DEFAULTS)}s(b,g);b.DEFAULTS={radius:55,stroke_width:30,font_color:"#333333",label_color:"#333333",fill_color:"#fff",stroke_color:"#81ae14",background_color:"#222222",text_shadow:false};return b}(v);v=function(g){function b(a,c,d,e){this.label=c;this.value=d;if(e==null)e={};b.__super__.constructor.call(this,a,new W(e));this.center_point=new l(this.width/2,this.height/2);this.r.customAttributes.arc=
...
a[i];e.push(this.r.path("M "+f+", "+this.options.y_padding+" L "+f+", "+d+" Z"))}i=0;for(j=c.length;i<j;i++){f=c[i];e.push(this.r.path("M "+this.options.x_padding+", "+f+" L "+h+", "+f+" Z"))}e.attr({stroke:"#ccc","stroke-width":1}).toBack();if(this.options.multi_axis===true&&this.line_options.length===2){e=this.options.x_padding;e=this.r.path("M "+e+", "+this.options.y_padding+" L "+e+", "+d+" Z");e.attr({stroke:this.line_options[0].line_color,"stroke-width":1});e=this.width-this.options.x_padding*
2;d=this.r.path("M "+e+", "+this.options.y_padding+" L "+e+", "+d+" Z");return d.attr({stroke:this.line_options[1].line_color,"stroke-width":1})}};b.prototype.create_scalers=function(a){var c,d,e,f,h,i,j,k,m,o=this;f=void 0;e=void 0;h=void 0;f=void 0;i=void 0;if(this.options.scale==="log"){d=new H;e=function(){var n,p,q;q=[];n=0;for(p=a.length;n<p;n++){j=a[n];q.push(new l(j.x,d(j.y)))}return q}();i=x.get_ranges_for_points(e);e=i[0];h=i[1];f=i[2];i=i[3]}else{i=x.get_ranges_for_points(a);e=i[0];h=i[1];
f=i[2];i=i[3]}if(this.options.y_axis_scale.length===2){f=this.options.y_axis_scale;i=f[0];f=f[1]}k=this.options.multi_axis?this.options.x_padding*2:this.options.x_padding;e=(new A).domain([h,e]).range([this.options.x_padding,this.width-k]);m=(new A).domain([i,f]).range([this.options.y_padding,this.height-this.options.y_padding]);c=function(n){return o.height-m(n)};f=this.options.scale==="log"?function(n){return c(d(n))}:c;return[e,f]};b.prototype.create_scalers_for_single_point=function(){var a=this;
...
b){function a(){this.constructor=g}for(var c in b)if(t.call(b,c))g[c]=b[c];a.prototype=b.prototype;g.prototype=new a;g.__super__=b.prototype;return g};y=function(g,b,a,c){return{label:g,value:b,average:a,comparison:c}};v=function(g){function b(a,c){if(c==null)c={};b.__super__.constructor.call(this,a,new N(c));this.bars=[]}s(b,g);b.prototype.add=function(){return this.bars.push(y.apply(y,arguments))};b.prototype.draw_background=function(a,c){return this.r.rect(this.options.x_padding,c,a.x,this.options.area_width).attr({fill:this.options.area_color,
stroke:"none"})};b.prototype.draw_line=function(a,c){return this.r.rect(this.options.x_padding,c.y-this.options.line_width/2,a.x,this.options.line_width).attr({fill:this.options.line_color,stroke:"none"})};b.prototype.draw_average=function(a,c){return this.r.rect(a.x-this.options.average_width/2,c-this.options.average_height/2,this.options.average_width,this.options.average_height).attr({fill:this.options.average_color,stroke:"none"})};b.prototype.draw_label=function(){};b.prototype.clear=function(){b.__super__.clear.call(this);
return this.bars=[]};b.prototype.draw=function(){var a,c,d,e,f,h,i,j,k,m;k=this.bars;m=[];a=i=0;for(j=k.length;i<j;a=++i){y=k[a];e=[new l(y.comparison,0),new l(y.value,0),new l(y.average,0),new l(0,0)];d=x.get_ranges_for_points(e);c=d[0];d=d[1];h=(new A).domain([d,c]).range([this.options.x_padding,this.width-this.options.x_padding]);c=function(){var o,n,p;p=[];o=0;for(n=e.length;o<n;o++){f=e[o];p.push(new l(h(f.x),0))}return p}();d=a*(this.options.area_width+this.options.bar_margin);this.draw_background(c[0],
d);a=d+this.options.area_width/2;this.draw_line(c[1],new l(c[0].x,a));this.draw_average(c[2],a);m.push((new z(this.r,0,d+this.options.area_width/2,y.label,"",this.size=14,this.options.font_family)).draw())}return m};return b}(w);r.BulletChart=v;t={}.hasOwnProperty;s=function(g,b){function a(){this.constructor=g}for(var c in b)if(t.call(b,c))g[c]=b[c];a.prototype=b.prototype;g.prototype=new a;g.__super__=b.prototype;return g};w=function(g){function b(a,c){if(c==null)c={};b.__super__.constructor.call(this,
a,new G(c));this.effective_height=this.height-this.options.y_padding;this.bar_options=[];this.bars=[];this.values=[]}s(b,g);b.prototype.add=function(a){var c,d;c=a.label;d=a.value;this.bar_options.push(G.merge(this.options,a.options));this.values.push(d);return this.bars.push({label:c,value:d})};b.prototype.render_bar=function(a,c,d,e){this.r.rect(d.x,d.y,this.options.bar_width,this.effective_height-d.y,this.options.rounding).attr({fill:e.bar_color,stroke:"none"});(new z(this.r,d.x+this.options.bar_width/
2,this.height-(this.options.x_label_size+5),a,"",this.options.x_label_size,this.options.font_family,this.options.x_label_color)).draw();return(new z(this.r,d.x+this.options.bar_width/2,d.y-this.options.y_label_size-5,c,"",this.options.y_label_size,this.options.font_family,this.options.y_label_color)).draw()};b.prototype.clear=function(){b.__super__.clear.call(this);this.bars=[];return this.values=[]};b.prototype.draw=function(){var a,c,d,e,f,h,i,j,k,m,o,n,p=this;e=function(){var q,u,L,M;L=this.values;
M=[];c=q=0;for(u=L.length;q<u;c=++q){i=L[c];M.push(new l(c,i))}return M}.call(this);e.push(new l(0,0));d=x.get_ranges_for_points(e);a=d[2];d=d[3];j=(new A).domain([d,a]).range([this.options.y_padding,this.height-this.options.y_padding]);d=function(q){return p.height-j(q)};o=this.bars;n=[];c=k=0;for(m=o.length;k<m;c=++k){a=o[c];f=c*(this.options.bar_width+this.options.bar_spacing)+this.options.x_padding;h=d(e[c].y);f=new l(f,h);n.push(this.render_bar(a.label,a.value,f,this.bar_options[c]))}return n};
return b}(w);r.BarChart=w});})();
